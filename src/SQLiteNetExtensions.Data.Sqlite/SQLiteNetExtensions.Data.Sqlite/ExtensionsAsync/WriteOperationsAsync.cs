...
using SQLiteNetExtensions.Data.Sqlite.Enums;
using SQLiteNetExtensions.Data.Sqlite.Exceptions;
using SQLiteNetExtensions.Data.Sqlite.Extensions.TextBlob;
using SQLiteNetExtensions.Data.Sqlite.MicroOrm;

namespace SQLiteNetExtensions.Data.Sqlite.Extensions;
...
public static class WriteOperationsAsync
{
	...
	public static async Task UpdateWithChildrenAsync(this SqliteConnection conn, object element)
	{
	...
	public static Task InsertWithChildrenAsync(this SqliteConnection conn, object element, bool recursive = false)
	{
	...
	/// <param name="element">Object to be inserted.</param>
	/// <param name="recursive">If set to <c>true</c> all the insert-cascade properties will be inserted</param>
	public static Task InsertOrReplaceWithChildrenAsync(this SqliteConnection conn, object element, bool recursive = false)
	{
	...
	/// <param name="recursive">If set to <c>true</c> all the insert-cascade properties will be inserted</param>
	public static Task InsertAllWithChildrenAsync(this SqliteConnection conn, IEnumerable elements, bool recursive = false)
	{
	...
	/// <param name="elements">Objects to be inserted.</param>
	/// <param name="recursive">If set to <c>true</c> all the insert-cascade properties will be inserted</param>
	public static Task InsertOrReplaceAllWithChildrenAsync(this SqliteConnection conn, IEnumerable elements, bool recursive = false)
	{
	...
	public static Task DeleteAllAsync(this SqliteConnection conn, IEnumerable objects, bool recursive = false)
	{
	...
	public static async Task DeleteAsync(this SqliteConnection conn, object element, bool recursive)
	{
		if (recursive)
		{
			await conn.DeleteAllAsync(new[] { element }, recursive);
		}
		else
		{
			await SqliteConnectionAsyncExtensions.DeleteAsync(conn, element);
		}
	}
	...
	public static Task DeleteAllIdsAsync<T>(this SqliteConnection conn, IEnumerable<object> primaryKeyValues)
	{
		var type = typeof(T);
	...
	static async Task InsertAllWithChildrenRecursiveAsync(this SqliteConnection conn, IEnumerable elements, bool replace, bool recursive, ISet<object>? objectCache = null)
	{
		if (elements == null)
		{
			return;
	...
	static async Task InsertWithChildrenRecursiveAsync(this SqliteConnection conn, object element, bool replace, bool recursive, ISet<object>? objectCache = null)
	{
		objectCache ??= new HashSet<object>();
	...
	static async Task InsertChildrenRecursiveAsync(this SqliteConnection conn, object element, bool replace, bool recursive, ISet<object>? objectCache = null)
	{
		if (element == null)
		{
			return;
	...
	static async Task InsertValueAsync(this SqliteConnection conn, object value, bool replace, bool recursive, ISet<object> objectCache)
	{
		if (value == null)
		{
			return;
	...
	static async Task<IEnumerable> InsertElementsAsync(this SqliteConnection conn, IEnumerable elements, bool replace, ISet<object> objectCache)
	{
		if (elements == null)
		{
	...
	static Task InsertElementAsync(this SqliteConnection conn, object element, bool replace, ISet<object> objectCache)
	{
	...
	static Task InsertElementAsync(this SqliteConnection conn, object element, bool replace, PropertyInfo? primaryKeyProperty, bool isAutoIncrementPrimaryKey, ISet<object>? objectCache)
	{
	...
	static async Task DeleteAllRecursiveAsync(this SqliteConnection conn, IEnumerable elements, bool recursive, ISet<object>? objectCache = null)
	{
		if (elements == null)
		{
			return;
	...
	static Task DeleteValueRecursiveAsync(this SqliteConnection conn, object value, bool recursive, ISet<object> objectCache)
	{
		if (value == null)
		{
			return Task.CompletedTask;
	...
	static async Task DeleteAllObjectsAsync(this SqliteConnection conn, IEnumerable elements)
	{
	...
	static async Task UpdateInverseForeignKeysAsync(this SqliteConnection conn, object element)
	{
		foreach (var relationshipProperty in element.GetType().GetRelationshipProperties())
		{
			var relationshipAttribute = relationshipProperty.GetAttribute<RelationshipAttribute>();
	...
	static async Task UpdateOneToManyInverseForeignKeyAsync(this SqliteConnection conn, object element, PropertyInfo relationshipProperty)
	{
		var type = element.GetType();
	...
	static async Task UpdateOneToOneInverseForeignKey(this SqliteConnection conn, object element, PropertyInfo relationshipProperty)
	{
		var type = element.GetType();
	...
	static async Task UpdateManyToManyForeignKeys(this SqliteConnection conn, object element, PropertyInfo relationshipProperty)
	{
		var type = element.GetType();
	...
	static async Task DeleteAllIdsAsync(this SqliteConnection conn, object[] primaryKeyValues, string entityName, string primaryKeyName)
	{
