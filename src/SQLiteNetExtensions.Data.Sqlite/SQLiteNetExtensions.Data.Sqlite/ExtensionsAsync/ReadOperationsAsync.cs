...
public static class ReadOperationsAsync
{
	...
	public static async Task<List<T>> GetAllWithChildrenAsync<T>(this SqliteConnection conn, Expression<Func<T, bool>>? filter = null, bool recursive = false)
	where T : new()
	{
	...
	/// <c>CascadeOperation.CascadeRead</c> will be loaded recusively.</param>
	/// <typeparam name="T">Entity type where the object should be fetched from</typeparam>
	public static async Task<T> GetWithChildrenAsync<T>(this SqliteConnection conn, object pk, bool recursive = false)
	where T : new()
	{
	...
	/// <c>CascadeOperation.CascadeRead</c> will be loaded recusively.</param>
	/// <typeparam name="T">Entity type where the object should be fetched from</typeparam>
	public static async Task<T> FindWithChildren<T>(this SqliteConnection conn, object pk, bool recursive = false)
	where T : new()
	{
	...
	/// <c>CascadeOperation.CascadeRead</c> will be loaded recusively.</param>
	/// <typeparam name="T">Entity type where the object should be fetched from</typeparam>
	public static Task GetChildrenAsync<T>(this SqliteConnection conn, T element, bool recursive = false)
	...
	/// <c>CascadeOperation.CascadeRead</c> will be loaded recusively.</param>
	/// <typeparam name="T">Entity type where the object should be fetched from</typeparam>
	public static Task GetChild<T>(this SqliteConnection conn, T element, Expression<Func<T, object>> propertyExpression, bool recursive = false)
	...
	/// <c>CascadeOperation.CascadeRead</c> will be loaded recusively.</param>
	/// <typeparam name="T">Entity type where the object should be fetched from</typeparam>
	public static Task GetChildAsync<T>(this SqliteConnection conn, T element, PropertyInfo relationshipProperty, bool recursive = false)
	{
		ArgumentNullException.ThrowIfNull(conn);
		ArgumentNullException.ThrowIfNull(element);
	...
	static async Task GetChildrenRecursiveAsync(this SqliteConnection conn, object? element, bool onlyCascadeChildren, bool recursive, ObjectCache? objectCache = null)
	{
		ArgumentNullException.ThrowIfNull(conn);
		ArgumentNullException.ThrowIfNull(element);
	...
	static async Task GetChildRecursiveAsync(this SqliteConnection conn, object element, PropertyInfo relationshipProperty, bool recursive, ObjectCache objectCache)
	{
		ArgumentNullException.ThrowIfNull(conn);
		ArgumentNullException.ThrowIfNull(element);
		ArgumentNullException.ThrowIfNull(relationshipProperty);
	...
	static async Task<object> GetOneToOneChildrenAsync<T>(this SqliteConnection conn, IList<T> elements,
	...
	static async Task<object> GetManyToOneChildrenAsync<T>(this SqliteConnection conn, IList<T> elements,
		PropertyInfo relationshipProperty,
		bool recursive, ObjectCache objectCache)
	{
		var primaryKeys = new Dictionary<object, IList<T>>();
		...
		{
			var placeHolders = string.Join(",", Enumerable.Repeat("?", primaryKeys.Count));
			var query = string.Format("select * from [{0}] where [{1}] in ({2})", tableMapping!.TableName, tableMapping.PK.Name, placeHolders);
	...
	static async Task<IEnumerable?> GetOneToManyChildrenAsync<T>(this SqliteConnection conn, T element,
		PropertyInfo relationshipProperty,
		bool recursive, ObjectCache objectCache)
	{
	...
	static async Task<IEnumerable?> GetManyToManyChildrenAsync<T>(this SqliteConnection conn, T element,
		PropertyInfo relationshipProperty,
		bool recursive, ObjectCache objectCache)
	{
		var type = element!.GetType();
	...
	static void Assert(bool assertion, Type? type, PropertyInfo? property, string message)
	{
		...
		{
			throw new IncorrectRelationshipException(type?.Name ?? string.Empty, property?.Name ?? string.Empty, message);
		}
	}
	...
	static object? GetObjectFromCache(Type objectType, object primaryKey, ObjectCache? objectCache)
	{
		...
		object? value = null;
		if (objectCache.TryGetValue(typeName, out Dictionary<object, object>? typeDict) && typeDict != null)
		{
	...
	static async Task GetChildrenRecursiveBatchedAsync<T>(this SqliteConnection conn, IList<T> elements, ObjectCache objectCache)
	{
		if (elements == null || elements.Count == 0)
		{
			return;
		...
		{
			var relationshipAttribute = relationshipProperty.GetAttribute<RelationshipAttribute>();
			if (relationshipAttribute?.IsCascadeRead == true)
			{
