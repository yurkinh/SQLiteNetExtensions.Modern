...
public class RecursiveReadAsyncTests
{
    ...
    public class TwitterUser
    {
        ...
        {
            return obj is TwitterUser other && Name?.Equals(other.Name) == true;
        }
    ...
    public static async Task<Tuple<bool, string>> TestManyToManyCascadeWithSameClassRelationshipAsync()
    {
        ...
        try
        {
            ...
            if (obtainedAnthony == null)
            {
                return new Tuple<bool, string>(false, $"User is null: {anthony.Name}");
            }
            ...
            if (obtainedJaime == null)
            {
                return new Tuple<bool, string>(false, $"User is null: {jaime.Name}");
            }
            ...
            {
                return new Tuple<bool, string>(false, $"User is null: {mark.Name}");
            }
